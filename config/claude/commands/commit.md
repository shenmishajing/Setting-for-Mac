...
2. If 0 files are staged, automatically adds all modified and new files with `git add`. If some files are already staged, only process with the staged files.
